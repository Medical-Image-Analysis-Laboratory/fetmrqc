...
# 1. qc_brain_extraction 2. qc_list_bids_csv 3. qc_segmentation 4. qc_compute_iqms
# 5. qc_run_inference
...
def main():
    ...
    parser.add_argument(
        "--masks_dir",
        help="Root of the BIDS directory where brain masks will be/are stored.",
        required=True,
    )

    parser.add_argument(
        "--seg_dir",
        help="Root of the directory where brain segmentations will be stored.",
        required=True,
    )
    parser.add_argument(
        "--bids_csv",
