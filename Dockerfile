...
RUN mkdir -p "$MAMBA_ROOT_PREFIX/lib/python3.9/site-packages/monaifbs/config" && wget -O "$MAMBA_ROOT_PREFIX/lib/python3.9/site-packages/monaifbs/config/monai_dynUnet_inference_config.yml" "https://raw.githubusercontent.com/gift-surg/MONAIfbs/main/monaifbs/config/monai_dynUnet_inference_config.yml"
